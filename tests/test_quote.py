...
def test_multi_item_quote_with_adjustment(seeded):
    ...
    assert ws.cell(18, 7).value == 22 * 100                # G 小计=值（预览器可见）
    ...
    assert ws.cell(23, 7).value == 22 * 100 + 31 * 500
    assert ws.cell(24, 7).value == round((22 * 100 + 31 * 500) * 0.3, 2)  # 默认定金30%
    assert ws.cell(25, 7).value == (22 * 100 + 31 * 500) - round((22 * 100 + 31 * 500) * 0.3, 2)
